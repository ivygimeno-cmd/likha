...
const termsSections: TermsSection[] = [
  {
    ...
    paragraphs: [
      "These Terms and Conditions govern your access to and use of LIKHA, an online buyer–seller marketplace operated by Gimeno Design Solutions.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "A LIKHA account may use buyer and seller workspaces. Switching workspaces does not create a separate identity or remove your responsibilities under these Terms.",
  ...
  },
  {
    ...
    paragraphs: [
      "LIKHA provides technology that allows buyers to post project requests, sellers to submit proposals, and both parties to manage orders and communicate.",
      "Unless expressly stated otherwise, Gimeno Design Solutions is not the manufacturer, seller, buyer, employer, agent, or representative of marketplace users.",
      "Buyers and sellers remain responsible for their agreements, products, services, taxes, permits, registrations, and other legal obligations.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Sellers must submit accurate proposals containing realistic prices, delivery times, capabilities, and conditions.",
      "When a buyer accepts a proposal, an order is created between the buyer and seller. Both parties must perform their responsibilities according to the accepted proposal, order details, and these Terms.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "LIKHA Credits are limited-use platform units that sellers may use to submit proposals and access other eligible marketplace features.",
      "LIKHA Credits are not legal tender, deposited money, seller earnings, or an electronic-wallet balance. They cannot be withdrawn, transferred, sold, gifted, exchanged for cash, or used to pay a seller for an order.",
  ...
  },
  {
    ...
    paragraphs: [
      "The current standard cost to submit one proposal is 15 LIKHA Credits. The exact Credit cost must be displayed to the seller before final submission.",
      "Credits are deducted when a proposal is successfully submitted. A seller will not receive a Credit refund merely because the proposal was rejected, was not selected, expired, or was voluntarily withdrawn.",
  ...
  },
  {
    ...
    paragraphs: [
      "Eligible newly identity-verified sellers may receive a one-time welcome bonus of 50 complimentary LIKHA Credits.",
      ...
      "Complimentary and promotional Credits have no cash value and cannot be withdrawn, transferred, sold, or exchanged for seller earnings.",
  ...
  },
  {
    ...
    paragraphs: [
      "Under the current LIKHA Credits model, LIKHA does not charge sellers a percentage commission on the agreed order price.",
      ...
      "Seller earnings come from payments made by buyers for accepted orders. LIKHA Credits cannot be converted into seller earnings or used as payment for completed work.",
  ...
  },
  {
    ...
    paragraphs: [
      "The seller must submit completed work through the order process within the agreed schedule.",
  ...
  {
    title: "12. Seller Responsibilities",
    paragraphs: [
      "Sellers are responsible for the quality, legality, safety, accuracy, and timely delivery of their products and services.",
    ],
    bullets: [
  ...
  },
  {
    ...
    paragraphs: [
      "Buyers must provide clear instructions, communicate honestly, maintain sufficient funds, and review seller submissions fairly.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Unless the buyer and seller expressly agree otherwise, pre-existing designs, trademarks, tools, methods, and materials remain owned by their original owner.",
